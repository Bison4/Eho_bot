...
button_start = telebot.types.KeyboardButton(text= 'Начнем бить негров?🤣')
...
keybord_start = telebot.types.ReplyKeyboardMarkup(resize_keyboard=True)
...
keybord_start.add(button_start)
